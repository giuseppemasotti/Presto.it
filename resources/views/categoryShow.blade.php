<x-layout>
    <div class="container form-custom mt-5 mb-5">
        <div class="row">
            <div class="col-12-col-md-6">
                <h1 class="display-4 text-center fw-bold">{{ $category->name }}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="card card-custom " data-aos="fade-right" data-aos-duration="1000">
                            ...
                            <div class="card-body shadow d-flex flex-column justify-content-between">
                                ...
                                <div class="pt-3 d-flex flex-column justify-content-between align-items-start">
                                    <div class="">
                                        <a href="{{route('announcement_show',compact('announcement'))}}" class="btn btn-dark shadow">{{__('ui.visualizza')}}</a>
                                    </div>
                    ...
                    <h2 class="text-center mt-3  fw-bold ">{{__('ui.pubblicalo')}}!
                        <p class="fs-3 text-center">{{__('ui.no-annunci')}}!</p>
